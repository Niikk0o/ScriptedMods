class AdvancedLoadouts extends AdminModuleManager
{
	//=============Mod Tunables=============
	protected bool m_StaticLoadouts     = false;  //TO USE YOU MUST HAVE --> AdvancedLoadouts mod active! (picks random loadout preset you have created using the admin command /export )
	protected bool m_RandomizedLoadouts = true;  //TO USE YOU MUST HAVE --> AdvancedLoadouts mod active! (picks random item to spawn on player from each catagory in 'LoaOuts\RandomlyGenerated')
	protected bool m_SpawnArmed		    = false;  //Spawn fresh spawns with a pistol, weapon types can be changed in 'DayZSurvival.c' All the way at the bottom in fucntion 'StartingEquipSetup'
	//======================================
